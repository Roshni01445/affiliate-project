...
# CONFIGURATION
BOT_TOKEN = "8134881042:AAGMyNA3djOjY1FmHadtbqu0gXLsAlL5P6s"
GOOGLE_SHEET_WEBHOOK_URL = "https://script.google.com/macros/s/AKfycbzOpYU6DGMqNtoFBg8E_i7kq4_rhI1I6AveEqfPcpkJQcjXFtUjmObzSM8_iFwnczGm/exec"
N8N_TRIGGER_URL = "https://n8n-production-3b51.up.railway.app/webhook-test/n8n-trigger"
N8N_POSTING_URL = "https://n8n-production-3b51.up.railway.app/webhook-test/posting"
...
def process_ai_caption(message):
    ...
    # Start Gemini Generation Thread
    ...
    # Start Monitoring Thread for Approval
...
def process_reel_caption(message):
    ...
    # Route correctly based on generation or direct posting
        ...
        if job_id in data and data[job_id].get("status") == "success":
            ...
            if os.path.exists(img_path):
                with open(img_path, 'rb') as f:
                    ...
                    # Capture the Telegram URL of the newly generated image to send to n8n upon approval
